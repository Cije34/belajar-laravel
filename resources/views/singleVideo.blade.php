    ...
    <div class="row">
        ...
        <div class="mb-5 col-md-9">
            <article class="bg-white p-4 rounded shadow-sm">
                ...
                @if($videos->image)
                <img src="{{ asset('storage/'.$videos->image->url) }}" class="img-fluid mb-3" alt="Article Image">
                @endif
                ...
                <p class="mt-4">{{$videos->updated_at}}</p>
            </article>
        </div>
    </div>
</div>
...
<div class="container mt-5 border p-4 rounded">
    <form action="{{url('/article/commentVideo/'.$videos->id)}}" method="POST">
        @csrf
        <div class="mb-3">
